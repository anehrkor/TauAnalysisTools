...
inputPath = "/pnfs/desy.de/cms/tier2/store/user/anehrkor/CMSPOS2017/PhaseIITDRSpring17_91X_upgrade2023_realistic/"

# generic path to NFS where we want to copy ntuples to
outputPath = "/nfs/dust/cms/user/anehrkor/CMSPOS2017/PhaseIITDRSpring17_91X_upgrade2023_realistic/ntuples/"
...
samples = {
    'ZplusJets_madgraph' : {
        'datasetpath'                        : 'DYJetsToLL_M-50_TuneCUETP8M1_14TeV-madgraphMLM-pythia8'
    },
    'TT_powheg': {
        'datasetpath'                        : 'TT_TuneCUETP8M1_14TeV-powheg-pythia8'
    },
    'PPmuXptGt20Mu15' : {
        'datasetpath'                        : 'QCD_Pt-20toInf_MuEnrichedPt15_TuneCUETP8M1_14TeV_pythia8'
    },
...
#    },
    'QCDjetsFlatPt15to7000' : {
        'datasetpath'                        : 'QCD_Flat_Pt-15to7000_TuneCUETP8M1_14TeV_pythia8'
    },
#    'QCDjetsPt30to50' : {
...
samples[ggSampleName] = {
    'datasetpath'                        : 'GluGluHToTauTau_M125_14TeV_powheg_pythia8'
}
vbfSampleName = "vbfHiggs125toTauTau"
samples[vbfSampleName] = {
    'datasetpath'                        : 'VBFHToTauTau_M125_14TeV_powheg_pythia8'
}
